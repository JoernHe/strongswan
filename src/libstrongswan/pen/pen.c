...
ENUM_NEXT(pen_names, PEN_IBM, PEN_IBM, PEN_IETF,
	"IBM");
ENUM_NEXT(pen_names, PEN_CISCO, PEN_CISCO, PEN_IBM,
	"Cisco");
ENUM_NEXT(pen_names, PEN_MICROSOFT, PEN_MICROSOFT, PEN_CISCO,
	"Microsoft");
...
ENUM_NEXT(pen_short_names, PEN_IBM, PEN_IBM, PEN_IETF,
	"IBM");
ENUM_NEXT(pen_short_names, PEN_CISCO, PEN_CISCO, PEN_IBM,
	"CSCO");
ENUM_NEXT(pen_short_names, PEN_MICROSOFT, PEN_MICROSOFT, PEN_CISCO,
	"MS");
